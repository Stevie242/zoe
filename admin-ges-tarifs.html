...
<body>
    ...
    <section id="menu">
        ...
        <div class="items">
            ...
            <li><i class="fas fa-users-line"></i><a href="admin-reservation.html">Reservation clients</a></li>
            <li><i class="fa-solid fa-location-pin"></i><a href="admin-ges-destination.html">Gestion des destination</a></li>
            <li class="active"><i class="fa-solid fa-money-bill"></i><a href="admin-ges-tarifs.html">Gestion des tarifs</a></li>
